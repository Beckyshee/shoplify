...
describe('AdminService', () => {
  ...
  it('should create product', () => {
    ...
    const req = httpMock.expectOne(
      'http://localhost:5400/product/createProduct'
    );
  ...
  it('should fetch soft deleted products', () => {
    ...
    const req = httpMock.expectOne(
      'http://localhost:5400/product/softDeletedProducts'
    );
    expect(req.request.method).toBe('GET');
    req.flush(products);
  });
  ...
  it('should update product', () => {
    ...
    const req = httpMock.expectOne(
      'http://localhost:5400/product/updateProduct'
    );
  ...
  it('should delete product', () => {
    ...
    const req = httpMock.expectOne(
      'http://localhost:5400/product/deleteProduct/1'
    );
